...
public class chat_server extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try{
            ...
            ss = new ServerSocket(1245); //server starts at 1201 port number
            s = ss.accept(); // now the server will accept the connections.
            ...
            while(!msgin.equals("exit")){
                msgin = din.readUTF();
                msg_area.setText(msg_area.getText().trim()+"\n Client:\t"+msgin); // displays the message... from client
            }
